    ...
    return (
        <div className=''>
            <div className='py-4 w-full flex pr-5 justify-end'>
                <a href="#" className="flex items-center px-3 py-2 w-fit rounded-lg dark:text-white bg-violet-500 shadow-md ">
            ...
            <div className='absolute top-0 left-0 w-full h-screen bg-gray-900 bg-opacity-90 flex items-center justify-center'>
                <div className='text-white w-[30vw] px-5 py-5 pb-8 bg-gray-800 shadow-lg rounded-lg'>
                    ...
                    <form action="">
                        <div className='pb-5'>
                            ...
                            <input type="text" name="" id="title" className='w-full px-4 py-2 text-sm border rounded-lg focus:ring-primary-500 focus:border-primary-500 bg-transparent mt-2' />
                        </div>
                        <div>
